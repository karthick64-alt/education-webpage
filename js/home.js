        ...
        <div class="col-lg-4 col-md-6">
            <div class="course-card card border-0 shadow-sm h-100 d-flex flex-column">
                ...
                <div class="card-body d-flex flex-column flex-grow-1">
                    ...
                    <h5 class="card-title fw-bold mb-2" style="min-height: 3rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">${course.title}</h5>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-auto pt-3 border-top">
                        <div class="d-flex flex-column">
                            <span class="fw-bold text-primary fs-5 mb-0">$${course.price}</span>
